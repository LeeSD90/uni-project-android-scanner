...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_bar_code);
    ...
    public void onClick(View v) {
        switch(v.getId()) {
            case R.id.saveButton:                                       // Save Barcode
                saveBarcode();                                          // Add the Barcode to the history file
                break;
            case R.id.removeButton:                                     // Remove Barcode
                removeBarcode();                                        // Remove the Barcode from the history file
                break;
            case R.id.findOnlineButton:                                       // Find online
