...
public class EbayLookup extends Lookup{
    ...
    public ArrayList<Product> lookup(Barcode b, String region) throws Exception{                    // Perform a remote lookup of the specified barcode and region on Ebay
    ...
    protected ArrayList<Product> parseResult(String responseXML) throws XmlPullParserException, IOException{    // Parse Ebays response XML, returning an array of Products containing the obtained information
    ...
    protected String getFormattedRegion(String region) {                                            // Takes the region string provided by the UI
        Log.d("Formatter ", region);                                                                // and sets the request domain appropriately
        switch(region){
            case "UK":
                return "EBAY-GB";
            case "US":
